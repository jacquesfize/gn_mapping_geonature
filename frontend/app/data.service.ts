...
export class OrganismStoreService {
  ...
  getOrganism(id_organism: number): Observable<OrganismFeature> {
    return this.http.get<OrganismFeature>(
      `${this.config_service.API_ENDPOINT}${this.module_prefix}/organisms/${id_organism}`
    );
  }

  updateOrganism(organism: Organism, id_organism: Number): Observable<OrganismFeature> {
  ...
  createOrganism(organism: Organism): Observable<OrganismFeature> {
    return this.http.post<any>(
      `${this.config_service.API_ENDPOINT}${this.module_prefix}/organisms`,
      organism
    );
  }
  getOrganisms(): Observable<OrganismFeatureCollection> {
    return this.http.get<OrganismFeatureCollection>(
      `${this.config_service.API_ENDPOINT}${this.module_prefix}/organisms`
    );
  }
}
